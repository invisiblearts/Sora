...
oUF.Tags.Events["Sora:Color"] = "UNIT_HEALTH UNIT_CONNECTION UNIT_REACTION"

oUF.Tags.Methods["Sora:Name"] = function(unit)
    return UnitName(unit)
end
oUF.Tags.Events["Sora:Name"] = "UNIT_NAME_UPDATE"

oUF.Tags.Methods["Sora:Health"] = function(unit)
    return S.FormatInteger(UnitHealth(unit))
end
oUF.Tags.Events["Sora:Health"] = "UNIT_HEALTH"
...
oUF.Tags.Events["Sora:PerHealth"] = "UNIT_HEALTH"

oUF.Tags.Methods["Sora:Power"] = function(unit)
    return S.FormatInteger(UnitPower(unit))
end
oUF.Tags.Events["Sora:Power"] = "UNIT_POWER"
...
oUF.Tags.Events["Sora:PerPower"] = "UNIT_POWER"
