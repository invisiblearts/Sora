...
function ClearFont:ApplySystemFonts()
    ...
    -- -----------------------------------------------------------------------------
    -- 聊天输入框字体
    if (CanSetFont(ChatFontNormal)) then ChatFontNormal:SetFont(CLEAR_FONT_CHAT, 12 * CF_SCALE, "OUTLINE"); end -- 预设值：14
    
    -- 聊天视窗默认字体
    if (CanSetFont(ChatFontSmall)) then ChatFontSmall:SetFont(CLEAR_FONT_CHAT, 12 * CF_SCALE, "OUTLINE"); end -- 预设值：12
    ...
    if (CanSetFont(QuestFont)) then QuestFont:SetTextColor(255, 255, 255); end -- 预设值：(0, 0, 0)
    ...
    if (CanSetFont(ItemTextFontNormal)) then ItemTextFontNormal:SetShadowColor(255, 255, 255); end -- 预设值：(0.18, 0.12, 0.06)
    ...
    if (CanSetFont(MailTextFontNormal)) then MailTextFontNormal:SetTextColor(255, 255, 255); end -- 预设值：(0.18, 0.12, 0.06)
